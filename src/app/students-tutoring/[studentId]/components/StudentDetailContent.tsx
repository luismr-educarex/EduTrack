...
import {
  ...
  FileText, GraduationCap, Mail, MessageSquare, TrendingUp,
} from 'lucide-react';
import {
...
import { tutoringService } from '@/lib/services/edutrackService';
...
export default function StudentDetailContent({ studentId }: { studentId: string }) {
  ...
  const {
    ...
    incidents, tutoringActions, loading, error, refreshTutoringActions,
  } = useEduTrack();
