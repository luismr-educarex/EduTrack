...
export function CourseManagementFeature() {
  ...
  const changeModuleDeliveryMode = async (module: Module, deliveryMode: Module['deliveryMode']) => { await moduleService.upsert({ ...module, deliveryMode }); toast.success(`Módulo cambiado a ${deliveryMode === 'online' ? 'online' : 'presencial'}`); window.location.reload(); };
