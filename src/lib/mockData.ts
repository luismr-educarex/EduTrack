...
export const LEARNING_OUTCOMES: LearningOutcome[] = [
  {
    ...
    code: 'RA1',
    description:
      'Desarrolla aplicaciones multiproceso, identificando y aplicando mecanismos de gestión de procesos del sistema operativo.',
    weight: 20,
  },
  {
    id: 'ra-2',
    code: 'RA2',
    description:
      'Desarrolla aplicaciones compuestas por varios hilos de ejecución analizando y aplicando librerías específicas del lenguaje utilizado.',
    weight: 25,
  },
  {
    id: 'ra-3',
...
export function getEffectiveRAGrade(
  ...
  if (runtimeAcademicData?.rubricItems.length) return baseGrade;
...
/** Returns the configured reference points: básico=3, medio=2, avanzado=1. */
...
/** Returns the reference point value: básico=3, medio=2, avanzado=1. */
export function getDifficultyPoints(difficulty: 'básico' | 'medio' | 'avanzado'): number {
  if (difficulty === 'básico') return 3;
...
export const CRITERIA: Criterion[] = [
  {
    ...
    raId: 'ra-1',
    code: 'RA1.a',
    description: 'Se han identificado los estados de un proceso y las transiciones entre ellos.',
    difficulty: 'básico',
    weight: 15,
  },
  {
    ...
    raId: 'ra-1',
    code: 'RA1.b',
    description: 'Se han utilizado clases para programar aplicaciones que crean subprocesos.',
    difficulty: 'medio',
    weight: 20,
  },
  {
    ...
    code: 'RA1.c',
    description:
      'Se han utilizado mecanismos para sincronizar y obtener el valor retornado por los subprocesos iniciados.',
    difficulty: 'medio',
    weight: 20,
  },
  {
    ...
    raId: 'ra-1',
    code: 'RA1.d',
    description: 'Se han utilizado clases que permiten gestionar la información entre procesos.',
    difficulty: 'medio',
    weight: 20,
  },
  {
    ...
    raId: 'ra-1',
    code: 'RA1.e',
    description: 'Se han desarrollado aplicaciones que ejecutan órdenes del sistema operativo.',
    difficulty: 'avanzado',
    weight: 25,
  },
  {
    ...
    code: 'RA2.a',
    description:
      'Se han identificado situaciones en las que resulta útil la utilización de varios hilos en un programa.',
    difficulty: 'básico',
    weight: 10,
  },
  {
    ...
    raId: 'ra-2',
    code: 'RA2.b',
    description: 'Se han utilizado clases para programar aplicaciones que crean hilos.',
    difficulty: 'medio',
    weight: 20,
  },
  {
    ...
    raId: 'ra-2',
    code: 'RA2.c',
    description: 'Se han compartido objetos y datos entre los hilos de un mismo proceso.',
    difficulty: 'medio',
    weight: 20,
  },
  {
    ...
    raId: 'ra-2',
    code: 'RA2.d',
    description: 'Se han utilizado mecanismos para evitar problemas de concurrencia.',
    difficulty: 'avanzado',
    weight: 25,
  },
  {
    ...
    raId: 'ra-2',
    code: 'RA2.e',
    description: 'Se han depurado y documentado las aplicaciones desarrolladas.',
    difficulty: 'medio',
    weight: 25,
  },
  {
    ...
    raId: 'ra-3',
    code: 'RA3.a',
    description: 'Se han identificado las características y campos de aplicación de los sockets.',
    difficulty: 'básico',
    weight: 15,
  },
  {
    ...
    code: 'RA3.b',
    description:
      'Se han utilizado sockets para programar una aplicación cliente que se comunica con un servidor.',
    difficulty: 'medio',
    weight: 25,
  },
  {
    ...
    code: 'RA3.c',
    description:
      'Se ha desarrollado una aplicación servidora que admite conexiones de múltiples clientes.',
    difficulty: 'avanzado',
    weight: 30,
  },
  {
    ...
    raId: 'ra-3',
    code: 'RA3.d',
    description: 'Se han utilizado hilos para implementar los procedimientos de las aplicaciones.',
    difficulty: 'medio',
    weight: 15,
  },
  {
    ...
    code: 'RA3.e',
    description:
      'Se han utilizado sockets UDP en la realización de aplicaciones que transmiten texto o archivos.',
    difficulty: 'medio',
    weight: 15,
  },
  {
    ...
    code: 'RA4.a',
    description:
      'Se han identificado las características propias de los servicios web y su papel en la arquitectura cliente-servidor.',
    difficulty: 'básico',
    weight: 15,
  },
  {
    ...
    code: 'RA4.b',
    description:
      'Se han utilizado servicios REST para intercambiar información entre aplicaciones.',
    difficulty: 'avanzado',
    weight: 30,
  },
  {
    ...
    raId: 'ra-4',
    code: 'RA4.c',
    description: 'Se ha programado un servicio REST sencillo con autenticación básica.',
    difficulty: 'avanzado',
    weight: 30,
  },
  {
    ...
    raId: 'ra-4',
    code: 'RA4.d',
    description: 'Se han documentado los servicios web desarrollados.',
    difficulty: 'medio',
    weight: 25,
  },
  {
    ...
    raId: 'ra-5',
    code: 'RA5.a',
    description: 'Se han identificado y aplicado mecanismos de autenticación y autorización.',
    difficulty: 'medio',
    weight: 40,
  },
  {
    ...
    code: 'RA5.b',
    description:
      'Se han utilizado protocolos seguros en la transmisión de datos entre aplicaciones.',
    difficulty: 'avanzado',
    weight: 35,
  },
  {
    ...
    code: 'RA5.c',
    description:
      'Se han aplicado técnicas de cifrado en el almacenamiento y transmisión de información sensible.',
    difficulty: 'avanzado',
    weight: 25,
  },
];
...
export const WORK_UNITS = [
  ...
  },
  {
    id: 'ut-3',
    code: 'UT3',
    name: 'Comunicación en Red con Sockets',
    evaluationId: 'eval-2',
    hours: 24,
    taughtPercentage: 75,
    status: 'en_curso',
...
export const ACTIVITIES: Activity[] = [
  {
    ...
    weight: 30,
    dueDate: '2025-10-15',
    description: 'Implementar un programa que crea procesos hijo usando fork() y exec().',
    ceIds: ['ce-1a', 'ce-1b', 'ce-1c'],
    correctionCount: 22,
    reviewedCount: 22,
  },
  {
    id: 'act-2',
    name: 'Práctica 2: Comunicación IPC',
    unitId: 'ut-1',
    evaluationId: 'eval-1',
    type: 'práctica',
    status: 'cerrada',
    weight: 40,
    dueDate: '2025-11-01',
    description: 'Usar pipes y memoria compartida para comunicar procesos.',
    ceIds: ['ce-1d', 'ce-1e'],
    correctionCount: 22,
    reviewedCount: 22,
  },
  {
    ...
    weight: 30,
    dueDate: '2025-11-15',
    description: 'Examen teórico-práctico sobre gestión de procesos.',
    ceIds: ['ce-1a', 'ce-1b', 'ce-1c', 'ce-1d', 'ce-1e'],
    correctionCount: 22,
    reviewedCount: 22,
  },
  {
    id: 'act-4',
    name: 'Práctica 3: Hilos con ExecutorService',
    unitId: 'ut-2',
    evaluationId: 'eval-1',
    type: 'práctica',
    status: 'revisada_docente',
    weight: 35,
    dueDate: '2025-11-30',
    description: 'Crear un pool de hilos para procesar tareas concurrentes.',
    ceIds: ['ce-2a', 'ce-2b', 'ce-2c'],
    correctionCount: 22,
    reviewedCount: 18,
  },
  {
    id: 'act-5',
    name: 'Práctica 4: Sincronización y locks',
    unitId: 'ut-2',
    evaluationId: 'eval-1',
    type: 'práctica',
    ...
    weight: 35,
    dueDate: '2025-12-10',
    description: 'Implementar soluciones al problema del productor-consumidor.',
    ceIds: ['ce-2d', 'ce-2e'],
    correctionCount: 22,
    reviewedCount: 10,
  },
  {
    ...
    weight: 30,
    dueDate: '2025-12-18',
    description: 'Examen teórico-práctico sobre programación multihilo.',
    ceIds: ['ce-2a', 'ce-2b', 'ce-2c', 'ce-2d', 'ce-2e'],
    correctionCount: 15,
    reviewedCount: 0,
  },
  {
    id: 'act-7',
    name: 'Práctica 5: Socket TCP cliente/servidor',
    unitId: 'ut-3',
    evaluationId: 'eval-2',
    type: 'práctica',
    status: 'en_correccion',
    weight: 40,
    dueDate: '2026-02-20',
    description: 'Desarrollar una aplicación chat usando sockets TCP.',
    ceIds: ['ce-3a', 'ce-3b', 'ce-3c'],
    correctionCount: 14,
    reviewedCount: 5,
  },
  {
    id: 'act-8',
    name: 'Práctica 6: Socket UDP y multihilo',
    unitId: 'ut-3',
    evaluationId: 'eval-2',
    type: 'práctica',
    status: 'borrador',
    weight: 35,
    dueDate: '2026-03-10',
    description: 'Implementar transferencia de archivos con sockets UDP.',
    ceIds: ['ce-3d', 'ce-3e'],
    correctionCount: 0,
    reviewedCount: 0,
  },
  {
    id: 'act-9',
    name: 'Práctica 7: API REST con Spring Boot',
    unitId: 'ut-4',
    evaluationId: 'eval-2',
    type: 'práctica',
    status: 'borrador',
    weight: 50,
    dueDate: '2026-04-05',
    description: 'Crear una API REST con autenticación JWT.',
    ceIds: ['ce-4a', 'ce-4b', 'ce-4c', 'ce-4d'],
    correctionCount: 0,
    reviewedCount: 0,
  },
  {
    id: 'act-10',
    name: 'Práctica 8: Seguridad TLS y cifrado',
    unitId: 'ut-5',
    evaluationId: 'eval-2',
    type: 'práctica',
    status: 'borrador',
    weight: 60,
    dueDate: '2026-05-10',
    description: 'Implementar comunicación segura con TLS y cifrado AES.',
    ceIds: ['ce-5a', 'ce-5b', 'ce-5c'],
    correctionCount: 0,
    reviewedCount: 0,
  },
];
...
export const STUDENTS: Student[] = [
  {
    ...
    avatar: 'AM',
    email: 'alejandro.martinez@edu.es',
    githubUrl: 'https://github.com/alejandro-martinez-psp',
    moduleGrade: 7.85,
    eval1Grade: 8.2,
    eval2Grade: 7.4,
    riskLevel: 'none',
  ...
  },
  {
    id: 'stu-2',
    nia: '22DAM002',
    name: 'Sara Rodríguez López',
    avatar: 'SR',
    email: 'sara.rodriguez@edu.es',
    githubUrl: 'https://github.com/sara-rodriguez-dam',
    moduleGrade: 9.1,
    eval1Grade: 9.3,
    eval2Grade: 8.8,
    riskLevel: 'none',
  ...
  },
  {
    ...
    avatar: 'MG',
    email: 'maria.gonzalez@edu.es',
    githubUrl: 'https://github.com/mgonzalez-psp2025',
    moduleGrade: 6.45,
    eval1Grade: 7.1,
    eval2Grade: 5.6,
    riskLevel: 'low',
  ...
  },
  {
    ...
    avatar: 'LJ',
    email: 'laura.jimenez@edu.es',
    githubUrl: 'https://github.com/laura-jimenez-dev',
    moduleGrade: 8.6,
    eval1Grade: 8.9,
    eval2Grade: 8.2,
    riskLevel: 'none',
  ...
  },
  {
    id: 'stu-8',
    nia: '22DAM008',
    name: 'Ana Romero Vega',
    avatar: 'AR',
    email: 'ana.romero@edu.es',
    githubUrl: 'https://github.com/ana-romero-psp',
    moduleGrade: 7.2,
    eval1Grade: 7.5,
    eval2Grade: 6.8,
    riskLevel: 'none',
  ...
  },
  {
    id: 'stu-9',
    nia: '22DAM009',
    name: 'Jorge Álvarez Núñez',
    avatar: 'JA',
    email: 'jorge.alvarez@edu.es',
    moduleGrade: 4.8,
    eval1Grade: 5.1,
    eval2Grade: 4.4,
    riskLevel: 'medium',
  ...
  },
  {
    id: 'stu-10',
    nia: '22DAM010',
    name: 'Elena Domínguez Gil',
    avatar: 'ED',
    email: 'elena.dominguez@edu.es',
    githubUrl: 'https://github.com/elena-dominguez-dam2',
    moduleGrade: 8.95,
    eval1Grade: 9.1,
    eval2Grade: 8.7,
    riskLevel: 'none',
  ...
  },
  {
    id: 'stu-11',
    nia: '22DAM011',
    name: 'Miguel Herrera Blanco',
    avatar: 'MH',
    email: 'miguel.herrera@edu.es',
    moduleGrade: 6.1,
    eval1Grade: 6.4,
    eval2Grade: 5.7,
    riskLevel: 'low',
  ...
  },
  {
    id: 'stu-12',
    nia: '22DAM012',
    name: 'Cristina Muñoz Serrano',
    avatar: 'CM',
    email: 'cristina.munoz@edu.es',
    githubUrl: 'https://github.com/cristina-munoz-psp',
    moduleGrade: 7.55,
    eval1Grade: 7.8,
    eval2Grade: 7.2,
    riskLevel: 'none',
  ...
  },
  {
    id: 'stu-13',
    nia: '22DAM013',
    name: 'Andrés Ortega Fuentes',
    avatar: 'AO',
    email: 'andres.ortega@edu.es',
    moduleGrade: 3.4,
    eval1Grade: 3.7,
    eval2Grade: 3.0,
    riskLevel: 'high',
  ...
  },
  {
    id: 'stu-14',
    nia: '22DAM014',
    name: 'Natalia Vargas Pinto',
    avatar: 'NV',
    email: 'natalia.vargas@edu.es',
    githubUrl: 'https://github.com/natalia-vargas-2025',
    moduleGrade: 8.3,
    eval1Grade: 8.6,
    eval2Grade: 7.9,
    riskLevel: 'none',
  ...
  },
  {
    id: 'stu-15',
    nia: '22DAM015',
    name: 'Iván Molina Ríos',
    avatar: 'IM',
    email: 'ivan.molina@edu.es',
    moduleGrade: 5.2,
    eval1Grade: 5.5,
    eval2Grade: 4.8,
    riskLevel: 'medium',
  ...
  },
  {
    id: 'stu-16',
    nia: '22DAM016',
    name: 'Beatriz Reyes Cabrera',
    avatar: 'BR',
    email: 'beatriz.reyes@edu.es',
    githubUrl: 'https://github.com/breyes-psp-dam',
    moduleGrade: 6.85,
    eval1Grade: 7.2,
    eval2Grade: 6.4,
    riskLevel: 'none',
  ...
  },
  {
    id: 'stu-17',
    nia: '22DAM017',
    name: 'Fernando Castillo Mora',
    avatar: 'FC',
    email: 'fernando.castillo@edu.es',
    githubUrl: 'https://github.com/fcastillo-dam2',
    moduleGrade: 7.4,
    eval1Grade: 7.6,
    eval2Grade: 7.1,
    riskLevel: 'none',
  ...
  },
  {
    id: 'stu-18',
    nia: '22DAM018',
    name: 'Silvia Navarro Espejo',
    avatar: 'SN',
    email: 'silvia.navarro@edu.es',
    moduleGrade: 4.6,
    eval1Grade: 5.0,
    eval2Grade: 4.1,
    riskLevel: 'medium',
  ...
  },
  {
    id: 'stu-19',
    nia: '22DAM019',
    name: 'Roberto Iglesias Vidal',
    avatar: 'RI',
    email: 'roberto.iglesias@edu.es',
    githubUrl: 'https://github.com/roberto-iglesias-psp',
    moduleGrade: 9.4,
    eval1Grade: 9.5,
    eval2Grade: 9.2,
    riskLevel: 'none',
  ...
  },
  {
    id: 'stu-20',
    nia: '22DAM020',
    name: 'Verónica Peña Solano',
    avatar: 'VP',
    email: 'veronica.pena@edu.es',
    moduleGrade: 6.2,
    eval1Grade: 6.5,
    eval2Grade: 5.8,
    riskLevel: 'low',
  ...
  },
  {
    id: 'stu-21',
    nia: '22DAM021',
    name: 'Hugo Aguilar Méndez',
    avatar: 'HA',
    email: 'hugo.aguilar@edu.es',
    moduleGrade: 5.9,
    eval1Grade: 6.2,
    eval2Grade: 5.5,
    riskLevel: 'low',
  ...
  },
  {
    id: 'stu-22',
    nia: '22DAM022',
    name: 'Lucía Campos Rubio',
    avatar: 'LC',
    email: 'lucia.campos@edu.es',
    githubUrl: 'https://github.com/lucia-campos-dam2',
    moduleGrade: 7.1,
    eval1Grade: 7.3,
    eval2Grade: 6.8,
    riskLevel: 'none',
...
function runtimeEvidence(studentId: string): CriterionEvidence[] {
  if (!runtimeAcademicData?.rubricItems.length) return [];
  const evidence: CriterionEvidence[] = [];
  [...runtimeAcademicData.activities]
    .sort((a, b) => a.dueDate.localeCompare(b.dueDate))
    .forEach((activity) => {
      const items = runtimeAcademicData!.rubricItems.filter(
        (item) => item.activityId === activity.id
      );
      if (!items.length) return;
      const activityWeight = activity.ceIds.reduce((sum, id) => {
        const criterion = runtimeAcademicData!.criteria.find((item) => item.id === id);
        return (
          sum +
          (criterion
            ? configuredCriterionWeight(
                criterion.difficulty,
                runtimeAcademicData!.criterionGradingConfig
              )
            : 0)
        );
      }, 0);
      const direct = directEvidenceForActivity(
        ...
        activityWeight,
        items,
        runtimeAcademicData!.rubricItemGrades.filter((item) => item.studentId === studentId)
      );
      evidence.push(
        ...direct,
        ...deriveImplicitEvidence(
          direct,
          evidence,
          runtimeAcademicData!.criterionImplications,
          runtimeAcademicData!.criterionGradingConfig
        )
      );
    });
...
export function getActivityGrade(studentId: string, activityId: string): number | null {
  if (runtimeAcademicData) {
    const items = runtimeAcademicData.rubricItems.filter((item) => item.activityId === activityId);
    if (items.length) {
      return rubricActivityGrade(
        items,
        runtimeAcademicData.rubricItemGrades.filter((item) => item.studentId === studentId)
      );
    }
    return domainActivityGrade(studentId, activityId, runtimeAcademicData.grades);
  }
...
export function getCEGrade(studentId: string, ceId: string): number | null {
  if (runtimeAcademicData) {
    const evidence = runtimeEvidence(studentId).filter((item) => item.criterionId === ceId);
    if (evidence.length)
      return aggregateCriterionEvidence(
        evidence,
        runtimeAcademicData.criterionGradingConfig.aggregationMode
      );
    return domainCriterionGrade(
      studentId,
      ceId,
      runtimeAcademicData.activities,
      runtimeAcademicData.criteria,
      runtimeAcademicData.grades
    );
  }
...
export function getCEStatus(
  grade: number | null
): 'superado' | 'parcial' | 'no_superado' | 'no_evaluado' {
...
export function getRAGrade(studentId: string, raId: string): number | null {
  if (runtimeAcademicData) {
    const raCriteria = runtimeAcademicData.criteria.filter((item) => item.raId === raId);
    const evidence = runtimeEvidence(studentId);
    if (
      raCriteria.some((criterion) => evidence.some((item) => item.criterionId === criterion.id))
    ) {
      return conditionalOutcomeGrade(
        raCriteria.map((item) => item.id),
        runtimeAcademicData.criteria,
        evidence,
        runtimeAcademicData.criterionGradingConfig
      ).grade;
    }
    return domainOutcomeGrade(
      studentId,
      raId,
      runtimeAcademicData.activities,
      runtimeAcademicData.criteria,
 ...
 * básico=3pt, medio=2pt, avanzado=1pt. This is the "peso" of the activity.
 */
export function getActivityCEWeight(activityId: string): number {
  ...
  if (runtimeAcademicData) {
    return act.ceIds.reduce((sum, id) => {
...
export function getActivityValuePct(activityId: string): number {
  if (!runtimeAcademicData) return domainActivityValuePercentage(activityId, ACTIVITIES, CRITERIA);
  const activity = runtimeAcademicData.activities.find((item) => item.id === activityId);
  if (!activity) return 0;
  const siblings = runtimeAcademicData.activities.filter((item) =>
    activity.unitId
      ? item.unitId === activity.unitId
      : !item.unitId && item.evaluationId === activity.evaluationId
  );
  const total = siblings.reduce((sum, item) => sum + getActivityCEWeight(item.id), 0);
  return total ? Number(((getActivityCEWeight(activityId) / total) * 100).toFixed(1)) : 0;
}
...
export function buildStudentGradeMap(studentId: string): StudentGradeMap {
  ...
  const evaluations: EvalGradeEntry[] = sourceEvaluations.map((ev) => {
    const units: UTGradeEntry[] = sourceWorkUnits
      .filter((ut) => ut.evaluationId === ev.id)
      .map((ut) => {
...
export const GRADE_TREND = [
  { label: '1ª Ev.', avg: 6.82, min: 3.4, max: 9.5 },
  { label: '2ª Ev.', avg: 5.95, min: 3.0, max: 9.2 },
];
...
export const INCIDENTS: Incident[] = [
  {
    id: 'inc-1',
    studentId: 'stu-3',
    studentName: 'Carlos Fernández Ruiz',
    date: '2026-07-10',
    type: 'aviso',
    detail: 'No entregó la práctica 5 en plazo. Tercera vez que ocurre.',
  },
  {
    id: 'inc-2',
    studentId: 'stu-5',
    studentName: 'David Sánchez Torres',
    date: '2026-07-09',
    type: 'falta',
    detail: 'Faltó a clase sin justificación. Acumuladas 12 faltas.',
  },
  {
    id: 'inc-3',
    studentId: 'stu-13',
    studentName: 'Andrés Ortega Fuentes',
    date: '2026-07-08',
    type: 'aviso',
    detail: 'No asistió al examen parcial. Pendiente de recuperación.',
  },
  {
    id: 'inc-4',
    studentId: 'stu-9',
    studentName: 'Jorge Álvarez Núñez',
    date: '2026-07-07',
    type: 'observación',
    detail: 'Muestra dificultades con la concurrencia. Se recomienda tutoría.',
  },
  {
    id: 'inc-5',
    studentId: 'stu-2',
    studentName: 'Sara Rodríguez López',
    date: '2026-07-05',
    type: 'positivo',
    detail: 'Excelente presentación del proyecto de hilos. Propuesta para exposición.',
  },
  {
    id: 'inc-6',
    studentId: 'stu-18',
    studentName: 'Silvia Navarro Espejo',
    date: '2026-07-03',
    type: 'observación',
    detail: 'Dificultades con el manejo de excepciones en sockets. Necesita refuerzo.',
  },
  {
    id: 'inc-7',
    studentId: 'stu-15',
    studentName: 'Iván Molina Ríos',
    date: '2026-07-01',
    type: 'aviso',
    detail: 'Entrega incompleta de la práctica 5. Falta la parte de sincronización.',
  },
  {
    id: 'inc-8',
    studentId: 'stu-1',
    studentName: 'Alejandro Martínez García',
    date: '2026-06-28',
    type: 'positivo',
    detail: 'Ayudó a compañeros con la depuración de hilos. Actitud colaborativa.',
  },
];
...
export const SESSION_LOGS: SessionLog[] = [
  {
    ...
    date: '2026-07-14',
    unitId: 'ut-3',
    development: 'Introducción a sockets UDP. Ejercicios de envío/recepción básico.',
    homework: 'Leer capítulo 8 del manual de redes.',
    notes: 'Buen ritmo general. Varios alumnos con dudas sobre el modelo cliente-servidor.',
  },
  {
    id: 'sl-2',
    date: '2026-07-11',
    unitId: 'ut-3',
    development: 'Práctica guiada: Socket TCP echo server con múltiples clientes.',
    homework: 'Completar práctica 5 para el lunes.',
    notes: 'David y Carlos no estuvieron en clase. Ana terminó antes y ayudó a compañeros.',
  },
  {
    id: 'sl-3',
    date: '2026-07-10',
    unitId: 'ut-3',
    development: 'Revisión de correcciones Práctica 4. Resolución de errores comunes.',
    homework: 'Revisar feedback individual en EduTrack.',
    notes: '8 alumnos pendientes de revisar su feedback. Recordar en próxima sesión.',
  },
  {
    id: 'sl-4',
    date: '2026-07-07',
    unitId: 'ut-3',
    development: 'Teoría: Modelo OSI y capa de transporte. Diferencias TCP/UDP.',
    homework: 'Ejercicios de teoría del libro, pág. 145-150.',
    notes: 'Clase muy participativa. Sara y Roberto destacaron con preguntas avanzadas.',
  },
  {
    id: 'sl-5',
    date: '2026-07-04',
    unitId: 'ut-2',
    development: 'Cierre UT2: Repaso general de concurrencia y patrones de diseño.',
    homework: 'Preparar examen UT2 para el jueves.',
    notes: 'Varios alumnos con dudas sobre ReentrantLock vs synchronized.',
  },
];
...
export const TUTORING_ACTIONS: TutoringAction[] = [
  {
    ...
    type: 'entrevista',
    content:
      'Entrevista individual. Carlos reconoce dificultades con la gestión del tiempo. Se acuerda plan de recuperación.',
    followUp: 'Revisión en 2 semanas',
  },
  {
    id: 'ta-2',
    studentId: 'stu-5',
    ...
    type: 'acuerdo',
    content:
      'Acuerdo de asistencia: David se compromete a asistir a todas las clases restantes. Se notifica a familia.',
    followUp: 'Control semanal de asistencia',
  },
  {
    id: 'ta-3',
    studentId: 'stu-13',
    date: '2026-07-08',
    type: 'seguimiento',
    content: 'Seguimiento de Andrés. Situación familiar complicada. Se deriva a orientación.',
    followUp: 'Coordinación con orientador',
  },
  {
    id: 'ta-4',
    studentId: 'stu-9',
    ...
    type: 'observación',
    content:
      'Jorge muestra mejora en las últimas semanas. Sigue necesitando apoyo en concurrencia.',
    followUp: 'Tutoría de refuerzo',
  },
  {
    id: 'ta-5',
    studentId: 'stu-15',
    ...
    type: 'entrevista',
    content:
      'Iván solicita tutoría voluntaria. Quiere mejorar nota final. Se le proporciona material adicional.',
    followUp: 'Entrega de ejercicios extra',
  },
];
...
export const CALENDAR_EVENTS: CalendarEvent[] = [
  {
    id: 'ev-1',
    date: '2026-07-14',
    title: 'Sesión: Sockets UDP',
    type: 'otro',
    notes: 'Introducción práctica',
  },
  {
    id: 'ev-2',
    date: '2026-07-18',
    title: 'Entrega Práctica 6',
    type: 'entrega',
    notes: 'Socket UDP y multihilo',
  },
  {
    id: 'ev-3',
    date: '2026-07-20',
    title: 'Examen UT3',
    type: 'examen',
    notes: 'Examen teórico-práctico de sockets',
  },
  {
    id: 'ev-4',
    date: '2026-07-25',
    ...
    type: 'tutoría',
    notes: 'Revisión de progreso 2ª evaluación',
  },
  {
    id: 'ev-5',
    date: '2026-08-01',
    title: 'Inicio UT4: REST',
    type: 'otro',
    notes: 'Servicios Web REST con Spring Boot',
  },
  { id: 'ev-6', date: '2026-08-15', title: 'Festivo', type: 'festivo' },
  {
    id: 'ev-7',
    date: '2026-09-05',
    title: 'Entrega Práctica 7',
    type: 'entrega',
    notes: 'API REST con autenticación JWT',
  },
  {
    id: 'ev-8',
    date: '2026-09-15',
    ...
    type: 'reunión',
    notes: 'Coordinación evaluación final',
  },
];
    ...
    rows: [
      {
        ...
        weight: 15,
        descriptors: {
          'lv-1': 'No identifica los estados del proceso.',
          'lv-2': 'Identifica algunos estados básicos.',
          'lv-3': 'Identifica y describe todos los estados.',
          'lv-4': 'Explica transiciones con ejemplos propios.',
        },
      },
      {
        id: 'row-2',
        ...
        weight: 20,
        descriptors: {
          'lv-1': 'No implementa fork/exec correctamente.',
          'lv-2': 'Implementa fork básico sin manejo de errores.',
          'lv-3': 'Implementa fork/exec con manejo de errores.',
          'lv-4': 'Implementación robusta con casos edge.',
        },
      },
      {
        id: 'row-3',
        ...
        weight: 20,
        descriptors: {
          'lv-1': 'No sincroniza procesos.',
          'lv-2': 'Sincronización básica con wait().',
          'lv-3': 'Sincronización correcta y obtiene valor retornado.',
          'lv-4': 'Manejo avanzado de señales y sincronización.',
        },
      },
    ],
  },
    ...
    rows: [
      {
        ...
        weight: 10,
        descriptors: {
          'lv-1': 'No identifica casos de uso de hilos.',
          'lv-2': 'Identifica casos básicos.',
          'lv-3': 'Justifica el uso de hilos con criterio.',
          'lv-4': 'Análisis completo con comparativa de alternativas.',
        },
      },
      {
        id: 'row-5',
        ...
        weight: 20,
        descriptors: {
          'lv-1': 'No crea hilos correctamente.',
          'lv-2': 'Crea hilos básicos con Thread.',
          'lv-3': 'Usa ExecutorService correctamente.',
          'lv-4': 'Pool de hilos optimizado con métricas.',
        },
      },
      {
        id: 'row-6',
        ...
        weight: 20,
        descriptors: {
          'lv-1': 'No comparte datos entre hilos.',
          'lv-2': 'Comparte datos sin sincronización.',
          'lv-3': 'Comparte datos con sincronización básica.',
          'lv-4': 'Uso de estructuras concurrentes avanzadas.',
        },
      },
    ],
  },
...
export const CE_COMPATIBILITIES: CECompatibility[] = [
  {
    ...
    factor: 0.7,
    active: true,
    notes: 'La sincronización de procesos es evidencia parcial de sincronización de hilos.',
  },
  {
    id: 'compat-2',
    originCeId: 'ce-2b',
    ...
    factor: 0.9,
    active: true,
    notes: 'Crear hilos es evidencia directa de usarlos en aplicaciones de red.',
  },
  {
    id: 'compat-3',
    originCeId: 'ce-3b',
    ...
    factor: 0.4,
    active: false,
    notes: 'Sockets TCP como contexto débil para servicios REST.',
  },
];
...
export const CORRECTIONS: Correction[] = [
  {
    ...
    aiScore: 7.8,
    teacherScore: 8.0,
    feedback: 'Buena implementación del servidor TCP. Falta manejo de desconexiones abruptas.',
    date: '2026-07-10',
  ...
  },
  {
    ...
    aiScore: 9.2,
    teacherScore: 9.5,
    feedback: 'Excelente. Implementación completa con manejo de errores y logging.',
    date: '2026-07-10',
    provider: 'OpenAI GPT-4o',
  },
  {
    ...
    aiScore: 4.1,
    teacherScore: null,
    feedback: 'El servidor no acepta múltiples conexiones simultáneas. Revisar uso de hilos.',
    date: '2026-07-11',
    provider: 'OpenAI GPT-4o',
  },
  {
    ...
    aiScore: 6.5,
    teacherScore: null,
    feedback: 'Implementación funcional pero sin manejo de excepciones.',
    date: '2026-07-11',
    provider: 'OpenAI GPT-4o',
  },
  {
    ...
    aiScore: 8.8,
    teacherScore: 8.5,
    feedback: 'Muy buena implementación. Código limpio y bien documentado.',
    date: '2026-07-09',
    provider: 'OpenAI GPT-4o',
  },
];
...
export const AI_PROVIDERS: AIProvider[] = [
  {
    ...
    model: 'gpt-4o',
    enabled: true,
    usage: 'Corrección automática de prácticas y generación de feedback detallado.',
  },
  {
    id: 'ai-2',
    code: 'anthropic',
    ...
    enabled: false,
    usage: 'Análisis de código y detección de patrones de error.',
  },
  {
    id: 'ai-3',
    code: 'deepseek',
    ...
    enabled: false,
    usage: 'Especializado en corrección de código Java y Python.',
  },
];
